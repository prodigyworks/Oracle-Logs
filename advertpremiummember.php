...
<form method="POST" action="premiummemberstage2.php" id="paypalform">
	...
	<table cellspacing=0 cellpadding=10 id="premiumupgrade" class="grid2">
		...
		<tr>
			...
			<td align=right><?php echo number_format($data->annualadvertisercost, 2); ?></td>
		...
		<tr>
			...
			<td align=right><?php echo number_format($data->quarterlyadvertisercost, 2); ?></td>
			<td>
		...
		<tr>
			...
			<td align=right><?php echo number_format($data->monthlyadvertisercost, 2); ?></td>
			<td>
...
<script>
	function stage2(type) {
		if (type == 1) {
			...
			$("#amount").val("<?php echo $data->annualadvertisercost; ?>");
			$("#period").val("Year");
			$("#frequency").val("1");
			$("#total_cycles").val("1");
			...
			$("#initial_amount").val("0.00");
			$("#amount").val("<?php echo $data->quarterlyadvertisercost; ?>");
			$("#period").val("Month");
			$("#frequency").val("3");
			$("#total_cycles").val("4");
			...
			$("#initial_amount").val("0.00");
			$("#amount").val("<?php echo $data->monthlyadvertisercost; ?>");
			$("#period").val("Month");
			$("#frequency").val("1");
			$("#total_cycles").val("12");
		}
